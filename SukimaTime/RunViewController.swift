...
//        stopButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 10)
//        stopButton.backgroundColor = UIColor.clear
//        stopButton.setTitleColor(UIColor(named: "Blue2"), for: .normal)
//        stopButton.layer.borderWidth = 5
        stopButton.layer.borderColor = UIColor(named: "Blue2")?.cgColor
//        stopButton.layer.cornerRadius=23.5
